    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    spacing: 0
                    StyledText { text: "UPTIME"; font.pixelSize: Appearance.font.pixelSize.smallest; font.weight: Font.DemiBold; color: "white" }
                    StyledText { text: SystemData.uptime || "--"; font.pixelSize: Appearance.font.pixelSize.small; font.weight: Font.Medium; color: "white" }
                }
                
                ColumnLayout {
                    spacing: 0
                    StyledText { text: "LOAD AVG"; font.pixelSize: Appearance.font.pixelSize.smallest; font.weight: Font.DemiBold; color: "white" }
                    StyledText { text: SystemData.loadAverage || "--"; font.pixelSize: Appearance.font.pixelSize.small; font.weight: Font.Medium; color: "white" }
                }
                
                ColumnLayout {
                    spacing: 0
                    StyledText { text: "PROCESSES"; font.pixelSize: Appearance.font.pixelSize.smallest; font.weight: Font.DemiBold; color: "white" }
                    StyledText { text: `${SystemData.processCount} (${SystemData.threadCount} threads)`; font.pixelSize: Appearance.font.pixelSize.small; font.weight: Font.Medium; color: "white" }
                }
            ...
            GridLayout {
                columns: mainLayout.width < 500 * Appearance.effectiveScale ? 1 : 2
                Layout.fillWidth: true
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                                ...
                                StyledText {
                                    text: SystemData.availableGpus.length > 0
                                        ? (SystemData.availableGpus[0].temp > 0
                                            ? `${SystemData.availableGpus[0].name} (${SystemData.availableGpus[0].temp}°C)`
                                            : SystemData.availableGpus[0].name)
                                        : ""
                            ...
                            StyledText {
                                text: SystemData.availableGpus.length > 0
                                    ? Math.round(SystemData.availableGpus[0].usage) + "%"
                                    : "0%"
                ...
                GraphCard {
                    ...
                    subValue: `${(SystemData.usedMemoryMB / 1024).toFixed(1)} GB / ${(SystemData.totalMemoryMB / 1024).toFixed(1)} GB`
