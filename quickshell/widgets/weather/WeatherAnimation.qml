...
Item {
    ...
    readonly property string weatherEffect: {
        let cond = (WeatherService.condition || "").toLowerCase();
        if (cond.indexOf("clear") !== -1 || cond.indexOf("sunny") !== -1) return "clear";
        if (cond.indexOf("rain") !== -1 || cond.indexOf("drizzle") !== -1 || cond.indexOf("shower") !== -1) return "rain";
        if (cond.indexOf("snow") !== -1 || cond.indexOf("flurries") !== -1 || cond.indexOf("ice") !== -1) return "snow";
        if (cond.indexOf("thunder") !== -1 || cond.indexOf("storm") !== -1) return "thunderstorm";
        if (cond.indexOf("fog") !== -1 || cond.indexOf("haze") !== -1 || cond.indexOf("mist") !== -1) return "fog";
        return "clouds"; 
    }
    ...
    Item {
        ...
        Item {
            ...
            Item {
                ...
                opacity: (!WeatherService.isDay && root.weatherEffect === "clear") ? 0.8 : 0
                visible: opacity > 0
            ...
            Item {
                ...
                property color dropColor: "#a5b1c2"
