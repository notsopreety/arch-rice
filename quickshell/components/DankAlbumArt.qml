...
Item {
    ...
    property string artUrl: activePlayer ? (activePlayer.trackArtUrl || activePlayer.artUrl || "") : ""
    ...
    DankCircularImage {
        ...
        RotationAnimation on rotation {
            ...
            paused: !root.activePlayer || root.activePlayer.playbackState !== 1
        }
    }
}
